...
(Да, критическое мышление, логическое мышление и абстрактное
мышление - разные штуки)
...
- toUpperCase() - приведение к верхнему регистру (собака => СОБАКА)
- toLowerCase() - обратное успокоение животного
